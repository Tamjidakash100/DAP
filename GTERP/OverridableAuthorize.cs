...
namespace GTERP
{
...

    {
        ...
        public void OnAuthorization(AuthorizationFilterContext filterContext)//, IServiceProvider serviceProvider
        {
            ...
            ////okcode///Uri url = new Uri(string.Format("https://gtrbd.net/ChitraAPITest/api/User/securitycheck"));
            ...
            if (userId == null || userId == "")
            {
                ...
                //       {"null","null" }
                //                    });
                filterContext.Result = new RedirectResult("~/Identity/Account/Login1");
            ...
            else
            {
                ...
                if (AllMenus != null)
                {
                    ...
                    var parMenu = AllMenus.Where(m => m.ModuleMenuId == parentId).FirstOrDefault();
                    if (parMenu != null)
                    {
                        parMenu.Active = true;
                    }
