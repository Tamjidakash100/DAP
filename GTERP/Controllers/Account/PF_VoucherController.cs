...
namespace GTERP.Controllers.Account
{
    ...
    public class PF_VoucherController : Controller
    {
        ...
        public PF_VoucherController(GTRDBContext context, clsProcedure _clsProc, TransactionLogRepository tran)//for report service
        {
            db = context;
            ...
            try
            {
...

                {
                    ...
                    else
                    {
                        ...
                        //var voucherfiscalyear = db.Acc_FiscalYears.Where(x => x.OpeningDate >= pf_voucherMain.VoucherDate).FirstOrDefault();
                        //var voucherfiscalyear = db.Acc_FiscalYears.Where(x => x.OpeningDate >= pf_voucherMain.VoucherDate && x.ClosingDate <= pf_voucherMain.VoucherDate).FirstOrDefault();
                        var voucherfiscalyear = db.Acc_FiscalYears.Where(x => x.comid == comid && x.OpeningDate <= pf_voucherMain.VoucherDate && x.ClosingDate >= pf_voucherMain.VoucherDate).FirstOrDefault();// && x.dtFrom.ToString() == monthid.ToString()
