    ...
    public class Acc_ChartOfAccountsController : Controller
    {
        ...
        public ActionResult Create()
        {
            try
            {
                ...
                if (lastacccoa != null)
                {
                    ...
                    ViewBag.AccumulatedDepId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("1-3-1")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text", lastacccoa.AccumulatedDepId).ToList();
                    ViewBag.DepExpenseId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("4-2-2")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text", lastacccoa.DepExpenseId).ToList();
                ...
                else
                {
                    ...
                    ViewBag.AccumulatedDepId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("1-3-1")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text").ToList();
                    ViewBag.DepExpenseId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("4-2-2")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text").ToList();
        ...
        public ActionResult Create(Acc_ChartOfAccount model, string title)
        {
            ...
            catch (Exception ex)
            {
                ...
                ViewBag.opFYId = new SelectList(db.Acc_FiscalYears.Where(c => c.FYId > 0 && c.comid == (HttpContext.Session.GetString("comid"))), "FYId", "FYName", model.opFYId);
                ViewBag.CountryId = new SelectList(db.Countries.Where(x => x.isActive == true), "CountryId", "CurrencyShortName", model.comid);
                ViewBag.AccumulatedDepId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("1-3-1")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text", model.AccumulatedDepId).ToList();
                ViewBag.DepExpenseId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("4-2-2")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text", model.DepExpenseId).ToList();
        ...
        public static string AccCodeMaker(string type, int level, int accsubid, string parentcode)
        {
            ...
            {///"-" + splitcode[3].ToString() + 
                FinalAccCode = splitcode[0].ToString() + "-" + splitcode[1].ToString() + "-" + splitcode[2].ToString() + "-" + accsubid.ToString();
        ...
        public ActionResult Edit(int? Id)
        {
            ...
            ViewBag.AccumulatedDepId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("1-3-1")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text", chartofaccount.AccumulatedDepId).ToList();
            ViewBag.DepExpenseId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("4-2-2")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ] " + " - [ " + s.AccType + " ] ", Value = s.AccId }).ToList(), "Value", "Text", chartofaccount.DepExpenseId).ToList();
