...
namespace GTERP.Controllers.Account
{
    ...
    public class Acc_BankClearingController : Controller
    {
        ...
        public ActionResult Print(int? id, string type)
        {
            ...
            string callBackUrl = this.Url.Action("Index", "ReportViewer", new { reporttype = ReportType }); //Repository.GenerateReport(ReportPath, strQueryMain, ConstrName, rptFormat);
