...
namespace GTERP.Controllers
{
    ...
    public class FA_MasterController : Controller
    {
        ...
        public JsonResult SetSessionProductReport(string rptFormat, string action, string FromDate, string ToDate)
        {
            try
            {
                ...
                if (action == "PrintDepreciationSchedule")
                {
                    ...
                    filename = "Depreciation_Schedule_" + DateTime.Now.Date;
                    HttpContext.Session.SetString("reportquery", "Exec Acc_rptDepreciationSchedule '" + comid + "',0,'" + FromDate + "','" + ToDate + "' ");
        ...
        [HttpGet]
        [ValidateAntiForgeryToken]
        public JsonResult PreviewAssignAsset(int detailsId)
        {
            try
            {
                var list = new List<TemDepSchedule>();
                ...
                var a = _context.FA_Details.Where(a => a.FA_DetailsId == detailsId).FirstOrDefault();
                // if (ModelState.IsValid)
                //{
                if (a != null)
                {
                    Tem_FA_Details asset = new Tem_FA_Details();
                    asset.AccumulatedDepreciatedValue = a.AccumulatedDepreciatedValue;
                    asset.AssetItem = a.AssetItem;
                    asset.AssignToDept = a.AssignToDept;
                    asset.AssignToSection = a.AssignToSection;
                    asset.CalculateDepreciation = a.CalculateDepreciation;
                    asset.ComId = a.ComId;
                    asset.DepCalFromDate = a.DepCalFromDate;
                    asset.EVAULife = a.EVAULife;
                    asset.FA_Dep_StatusId = a.FA_Dep_StatusId;
                    asset.FA_DetailsId = a.FA_DetailsId;
                    asset.FA_MasterId = a.FA_MasterId;
                    asset.IsDelete = a.IsDelete;
                    asset.IsDepRunning = a.IsDepRunning;
                    asset.IsInActive = a.IsInActive;
                    asset.IssueDate = a.IssueDate;
                    asset.IssuNo = a.IssuNo;
                    asset.PurchaseDate = a.PurchaseDate;
                    asset.PurchaseValue = a.PurchaseValue;
                    asset.RemainingYear = a.RemainingYear;
                    asset.UsefullLife = a.UsefullLife;
                    asset.WrittenDownValue = a.WrittenDownValue;
        ...
        public ActionResult Print(int? id, string type, string FromDate, string ToDate)
        {
            string SqlCmd = "";
            string ReportPath = "";
            var ConstrName = "ApplicationServices";
            ...
            HttpContext.Session.SetString("ReportPath", "~/ReportViewer/Accounts/" + reportname + ".rdlc");
            HttpContext.Session.SetString("reportquery", "Exec [Acc_rptFixedAssets] '" + comid + "','" + id + "','" + FromDate + "','" + ToDate + "'");
