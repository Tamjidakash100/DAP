...
namespace GTERP.Controllers.HR
{
    ...
    public class TotalNightController : Controller
    {
        GTRDBContext db;
        public TotalNightController(GTRDBContext context)
        {
            db = context;
        }
        ...
        public IActionResult Search(string prossType)
        {
            ...
            var OTFCList = Helper.ExecProcMapTList<OTFC>("[Payroll_prcGetSalaryNight]", parameter);
