...
namespace GTERP.Controllers.HR
{
    ...
    public class LoanHouseBuildingController : Controller
    {
        private GTRDBContext db;
        public LoanHouseBuildingController(GTRDBContext context)
        {
            db = context;
        }
        ...
        [HttpPost]
        public IActionResult Create(HR_Loan_HouseBuilding hR_Loan_HouseBuilding, bool newCalculation)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        hR_Loan_HouseBuilding.UpdateByUserId = comid;
                    ...
                    {
                        var unPaidLoan = db.HR_Loan_Data_HouseBuilding
        ...
        public IActionResult GetEmp(int id)
        {
            ...
            if (loandMaster != null)
            {
                ...
                ViewBag.LoanCalculation = db.HR_Loan_Data_HouseBuilding
                    .Where(l => l.LoanHouseId == loandMaster.LoanHouseId).OrderBy(l => l.DtLoanMonth).ToList();
        ...
        public IActionResult Edit(int id)
        {
            ...
            var loandMaster = db.HR_Loan_HouseBuilding
                ...
                .Include(l => l.HR_Emp_Info.Cat_Designation)
                .Include(l => l.HR_Emp_Info.HR_Emp_Image)
                .Where(l => l.LoanHouseId == id).FirstOrDefault();
            string comid = HttpContext.Session.GetString("comid");
            if (loandMaster != null)
            {
                ViewBag.Title = "Edit";
                ...
                ViewBag.LoanCalculation = db.HR_Loan_Data_HouseBuilding
                    .Where(l => l.LoanHouseId == id).OrderBy(l => l.DtLoanMonth).ToList();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            try
            {
                var detailsLoan = await db.HR_Loan_Data_HouseBuilding.Where(l => l.LoanHouseId == id).ToListAsync();
