...
namespace GTERP.Controllers.Account_GTF
{
    ...
    public class GTF_GeneralReportController : Controller
    {
        ...
        public GTF_GeneralReportController(GTRDBContext context, POSRepository _POS, TransactionLogRepository trans)
        {
            db = context;
            POS = _POS;
            //Repository = rep;
        ...
        public ActionResult DemoReport(string AccId, string FYId, string dtFrom, string dtTo, string CountryId, string IsLocalCurrency, string SupplierId, string CustomerId, string EmployeeId)
        {
            try
            {
                ...
                var quary = $"EXEC GTF_rptLedgerMultiDrCr '{comid}',{AccId},'{FYId}','{dtFrom}','{dtTo}' ,'{CountryId}','{IsLocalCurrency}','{userid}','{SupplierId}','{CustomerId}','{EmployeeId}' ";

                //Exec GTF_rptLedgerMultiDrCr '31312c54-659b-4e63-b4ba-2bc3d7b05792', 10165, 0, '01-Jul-2020', '28-Nov-2020', 18,0 ,'4864add7-0ab2-4c4f-9eb8-6b63a425e665' , '', '', ''
                AccId = "10165";
                FYId = "0";
                dtFrom = "01-Jul-2020";
                dtTo = "30-Nov-2020";
                ...
                List<LedgerDetailsModel> bookingDeliveryChallan = Helper.ExecProcMapTList<LedgerDetailsModel>("GTF_rptLedgerMultiDrCr", parameters);
        ...
        public ActionResult Report()
        {
            ...
            this.ViewBag.AccIdRecPay = new SelectList(db.GTF_ChartOfAccounts.Where(p => p.comid == comid && p.AccType == "L" && p.IsBankItem == true || p.IsCashItem == true && p.AccCode.Contains("1-1-1")).Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ]", Value = s.AccId }).ToList(), "Value", "Text");
            this.ViewBag.AccIdLedger = new SelectList(db.GTF_ChartOfAccounts.Where(p => p.comid == comid && p.AccType == "L").Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ]", Value = s.AccId }).ToList(), "Value", "Text");
            this.ViewBag.AccIdGroup = new SelectList(db.GTF_ChartOfAccounts.Where(p => p.comid == comid && p.AccType == "G").Select(s => new { Text = s.AccName + " - [ " + s.AccCode + " ]", Value = s.AccId }).ToList(), "Value", "Text");
            //this.ViewBag.AccIdNoteOneCT = new SelectList(db.GTF_VoucherSubs
            //    .Include(x=>x.GTF_VoucherMain)
            //    .Where(p => p.GTF_VoucherMain.comid == comid && p.Note1.Contains("CT"))
            //    .Select(s => new { Text = s.Note1 , Value = s.VoucherSubId }).Distinct()
            //    .ToList(), "Value", "Text");
            this.ViewBag.AccIdNoteOneCT = new SelectList(db.GTF_VoucherSubs
            .Include(x => x.GTF_VoucherMain)
            .Where(p => p.GTF_VoucherMain.comid == comid && p.Note1.Contains("CT") && p.Note1.Length > 3)
            ...
            int? SupplierId, int? CustomerId, int? EmployeeId, string AccIdNoteOneCT, string MinAccCode, string MaxAccCode)
        {
            ...
            try
            {
                ...
                if (rpttype == "RP")
                {
                    ...
                    {
                        filename = "ReceiptAndPay_Date_" + dtFrom + "_To_" + dtTo;// db.GTF_VoucherMains.Where(x => x.VoucherNo == VoucherFrom).Select(x => x.VoucherNo + "_" + x.GTF_VoucherType.VoucherTypeName).Single();
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptRecPay '" + comid + "','" + userid + "', '" + dtFrom + "','" + dtTo + "', " + AccIdRecPay + ", " + Currency + " ");
                ...
                if (rpttype == "CB")
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptLedgerMultiDrCr_CashBook '" + comid + "', " + AccIdRecPay + ", 0, '" + dtFrom + "', '" + dtTo + "', " + Currency + "," + isLocalCurr + ",'" + userid + "'  ");
                    ...
                    {
                        filename = "LedgerDetails_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptLedgerMultiDrCr_CashBook '" + comid + "', " + AccIdRecPay + ", " + FYId.ToString() + ", '01-Jan-1900', '01-Jan-1900', " + Currency + ", " + isLocalCurr + " ,'" + userid + "'  ");
                ...
                else if (rpttype.ToUpper().ToString() == "Tran".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptTransaction '" + comid + "', '" + userid + "', '" + dtFrom + "', '" + dtTo + "'," + Currency + " ," + AccVoucherTypeId + "  ");
                ...
                else if (rpttype.ToUpper().ToString() == "TranVoucherNo".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptTransaction_VoucherNo '" + comid + "', '" + userid + "', '" + dtFrom + "', '" + dtTo + "'," + Currency + "," + AccVoucherTypeId + "  ");
                ...
                else if (rpttype.ToUpper().ToString() == "ledgerD".ToUpper())
                {
                    ...
                    {
                        filename = "LedgerDetails_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptLedgerMultiDrCr '" + comid + "', " + AccIdLedger + ", 0, '" + dtFrom + "', '" + dtTo + "', " + Currency + "," + isLocalCurr + " ,'" + userid + "' , '" + SupplierId + "', '" + CustomerId + "', '" + EmployeeId + "'  ");
                    ...
                    {
                        filename = "LedgerDetails_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptLedgerMultiDrCr '" + comid + "', " + AccIdLedger + ", " + FYId.ToString() + ", '01-Jan-1900', '01-Jan-1900', " + Currency + ", " + isLocalCurr + ",'" + userid + "' ,'" + SupplierId + "',  '" + CustomerId + "', '" + EmployeeId + "'   ");
                ...
                else if (rpttype.ToUpper().ToString() == "ledgerA".ToUpper())
                {
                    ...
                    {
                        filename = "LedgerDetails_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptLedgerMultiAll '" + comid + "', " + AccIdLedger + ", 0, '" + dtFrom + "', '" + dtTo + "', " + Currency + "," + isLocalCurr + " ,'" + userid + "' , '" + MinAccCode + "',  '" + MaxAccCode + "', '" + EmployeeId + "'  ");
                    ...
                    {
                        filename = "LedgerDetails_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptLedgerMultiAll '" + comid + "', " + AccIdLedger + ", " + FYId.ToString() + ", '01-Jan-1900', '01-Jan-1900', " + Currency + ", " + isLocalCurr + ",'" + userid + "' ,'" + MinAccCode + "',  '" + MaxAccCode + "', '" + EmployeeId + "'   ");
                ...
                else if (rpttype.ToUpper().ToString() == "ADSUP".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec [GTF_rptAdvanceMoney_Supplier_Schedule] '" + comid + "', '" + dtFrom + "' ,'" + dtTo + "' ,'Advance to Supplier' , null,'" + AccIdLedger + "'");
                    }
                    else
                    {
                        filename = "rptAdvanceMoney_Supplier_Schedule" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec [GTF_rptAdvanceMoney_Supplier_Schedule] '" + comid + "', '" + dtFrom + "' ,'" + dtTo + "' ,'Advance to Supplier' ,'" + FYId.ToString() + "','" + AccIdLedger + "' ");
                    }
                }
                ...
                else if (rpttype.ToUpper().ToString() == "ADEMP".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec [GTF_rptAdvanceMoney_Employee_Schedule] '" + comid + "', '" + dtFrom + "' ,'" + dtTo + "' ,'Advance to Employee' , null ,'" + AccIdLedger + "' ");
                    }
                    else
                    {
                        filename = "rptAdvanceMoney_Employee_Schedule" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec [GTF_rptAdvanceMoney_Employee_Schedule] '" + comid + "', '" + dtFrom + "' ,'" + dtTo + "' ,'Advance to Employee' ,'" + FYId.ToString() + "','" + AccIdLedger + "' ");
                    }
                }
                ...
                else if (rpttype.ToUpper().ToString() == "GroupD".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        filename = "LedgerDetails_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec  GTF_rptGroupMultiDrCr '" + comid + "', " + AccIdGroup + ", 0, '" + dtFrom + "', '" + dtTo + "', " + Currency + " ,'" + userid + "'  ");

                    }
                    else
                    {
                        filename = "LedgerDetails_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec  GTF_rptGroupMultiDrCr '" + comid + "', " + AccIdGroup + ", " + FYId.ToString() + ", '" + dtFrom + "', '" + dtTo + "', " + Currency + " ,'" + userid + "'  ");
                ...
                else if (rpttype.ToUpper().ToString() == "GroupS".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec  GTF_rptSubsidiaryLedger '" + comid + "', " + AccIdGroup + ", 0, '" + dtFrom + "', '" + dtTo + "', " + Currency + " ,'" + userid + "' ,'" + Note1 + "' ");

                    }
                    else
                    {
                        filename = "SubsidiaryLedger_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec  GTF_rptSubsidiaryLedger '" + comid + "', " + AccIdGroup + ", " + FYId.ToString() + ", '" + dtFrom + "', '" + dtTo + "', " + Currency + " ,'" + userid + "' ,'" + Note1 + "' ");
                ...
                else if (rpttype.ToUpper().ToString() == "BankRecon".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec  [GTF_rptBankReconciliation] '" + comid + "', " + AccIdLedger + ",'" + dtFrom + "', '" + dtTo + "' ,'" + userid + "'  ");
                ...
                else if (rpttype.ToUpper().ToString() == "CashFlow".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec  [GTF_rptCashFlowStatement] '" + comid + "', " + AccIdLedger + ", '" + dtFrom + "', '" + dtTo + "'");
                ...
                else if (rpttype.ToUpper().ToString() == "FundFlow".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec  [GTF_rptFundFlowStatement] '" + comid + "', " + AccIdLedger + ", '" + dtFrom + "', '" + dtTo + "'");
                ...
                else if (rpttype.ToUpper().ToString() == "FdrList".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec  [GTF_rptFDRList] '" + comid + "', '" + dtFrom + "', '" + dtTo + "'");
                ...
                else if (rpttype.ToUpper().ToString() == "FdrListV".ToUpper())
                {
                    ...
                    if (criteria.ToUpper().ToString() == "Date".ToUpper())
                    {
                        ...
                        filename = "FDRList_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec  [GTF_rptFDRList_Voucher] '" + comid + "', '" + dtFrom + "', '" + dtTo + "'");
                ...
                else if (rpttype.ToUpper().ToString() == "BSPF".ToUpper())
                {
                    ...
                    //    filename = "GTF_BalanceSheet_Date_" + dtFrom + "_To_" + dtTo;
                    //    HttpContext.Session.SetString("reportquery", "Exec GTF_BalanceSheet '" + userid + "','" + comid + "','" + criteria + "', '" + strId + "','" + isShowZero + "','" + Currency + "',1 ");
                    //}
                    ...
                    //else
                    {
                        ...
                        reportname = "rptBalanceSheet_PF";
                        filename = "GTF_BalanceSheetCompare_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec GTF_BalanceSheet '" + userid + "','" + comid + "','" + criteria + "', '" + strId + "',1");
                ...
                else if (rpttype.ToUpper().ToString() == "ISPF".ToUpper())
                {
                    ...
                    //    HttpContext.Session.SetString("reportquery", "Exec GTF_rptIncomeCompare '" + userid + "','" + comid + "','" + criteria + "', '" + strId + "','" + isShowZero + "','" + Currency + "',0 ");
                    ...
                    //    reportname = "rptIncomeCompare";
                    //    filename = "IncomeStatementCompare_Date_" + dtFrom + "_To_" + dtTo;
                    //    HttpContext.Session.SetString("reportquery", "Exec GTF_rptIncomeCumulative '" + userid + "','" + comid + "','" + criteria + "', '" + strId + "','" + isShowZero + "','" + Currency + "',0 ");
                    ...
                    //else
                    {
                        ...
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptIncome '" + userid + "','" + comid + "','" + criteria + "', '" + strId + "','" + isShowZero + "','" + Currency + "' ");
                    }
                }
                ...
                else if (rpttype.ToUpper().ToString() == "NRPF".ToUpper())
                {
                    ...
                    //    HttpContext.Session.SetString("reportquery", "Exec GTF_rptNotes_Compare '" + userid + "','" + comid + "','" + criteria + "', '" + strId + "', '" + isShowZero + "','" + Currency + "',0");
                    ...
                    //    HttpContext.Session.SetString("reportquery", "Exec GTF_rptNotes_Cumulative '" + userid + "','" + comid + "','" + criteria + "','" + strId + "', '" + isShowZero + "' ,'" + Currency + "',1 ");
                    ...
                    //else
                    {
                        reportname = "rptNotes_PF";
                        filename = "PFNotesReprot_Date_" + dtFrom + "_To_" + dtTo;
                        HttpContext.Session.SetString("reportquery", "Exec GTF_rptNotes '" + userid + "','" + comid + "','" + criteria + "','" + strId + "', '" + isShowZero + "' ,'" + Currency + "',1 ");
