...
namespace GTERP.Controllers.Buffer
{
    ...
    public class RepresentativeBookingController : Controller
    {
        ...
        public IActionResult RepresentativeByBuffer(int? Yearid, int? Monthid, int? BufferListId, int? BufferRepresentativeId, int? fromcode, int? tocode, float? allotmentQty)
        {
            try
            {
                var result = "";
                ...
                List<BufferBookingDelChallan> bookingDeliveryChallan = Helper.ExecProcMapTList<BufferBookingDelChallan>("PrcRepresentativeWiseBooking", parameters);
        ...
        public JsonResult AllotmentInfo(int id, int yearid, int monthid)
        {
            try
            {
                ...
                bufferbooking.AvailavleQty = PrevAllotmentQty;
        ...
        //DTOs For GetBufferRepresantative Method 


        [HttpPost]
        public ActionResult GetBufferRepresantative(int BufferID)
        {
            ...
            var GetRepresentative = (from p in _context.BuferRepresentative
                                     join s in _context.RepresentativeBuffers.Where(x => x.BufferListId == BufferID) on p.BufferRepresentativeId equals s.BufferRepresentativeId
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.BufferRepresentativeId = new SelectList(_context.BuferRepresentative.Where(x => x.comid == comid), "BufferRepresentativeId", "RepresentativeName ");
