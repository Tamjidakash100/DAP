...
namespace GTERP.Controllers.Budget
{
    ...
    public class Budget_ProductionTargetController : Controller
    {
        ...
        public Budget_ProductionTargetController(GTRDBContext context, clsProcedure _clsProc, TransactionLogRepository tran)//for report service
        {
        ...
        public ViewResult Index(string FromDate, string ToDate, string criteria)
        {
            ...
            if (FromDate == null || FromDate == "")
            {
                ...
                abcd = db.Budget_ProductionTargets.Include(x => x.PrdUnit).Where(x => x.comid == comid).ToList();
            ...
            //return View(db.Budget_ProductionTargets.Where(c => c.ProductionTargetId > 0).ToList());
            return View(abcd);
        ...
        public ActionResult Create()
        {
            ...
            var x = db.Budget_ProductionTargets.Where(x => x.comid == comid).OrderByDescending(x => x.ProductionTargetId).FirstOrDefault();
            if (x != null)
            {
        ...
        public ActionResult Create(Budget_ProductionTarget Acc_GovtSchedulevar)
        {
            ...
            //if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    db.Budget_ProductionTargets.Add(Acc_GovtSchedulevar);
                    db.SaveChanges();


                    //db.Entry(Acc_GovtSchedulevar).GetDatabaseValues();
                    //int id = Budget_ProductionTarget.ProductionTargetId; // Yes it's here



                    //db.Categories.Add(Budget_ProductionTarget);

                }
            }
            return RedirectToAction("Create");

            //return View(Budget_ProductionTarget);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Budget_ProductionTarget Budget_ProductionTarget = db.Budget_ProductionTargets.Where(c => c.ProductionTargetId == id).FirstOrDefault();
        ...
        public JsonResult DeleteConfirmed(int? id)
        {
            try
            {
                ...
                db.Budget_ProductionTargets.Remove(Budget_ProductionTarget);
                db.SaveChanges();
