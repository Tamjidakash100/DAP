...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20200805173002_Grrsubwarehouseadd")]
    partial class Grrsubwarehouseadd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GTERP.Models.AccountDetails", b =>
                {
                    ...
                    b.Property<bool>("CapitalWorkInProgressAccount")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GTERP.Models.AdditionalOptions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("AllowMonthlyDepreciation")
                        .HasColumnType("bit");

                    b.Property<decimal>("CVADepreciation")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("IsExistingAsset")
                        .HasColumnType("bit");

                    b.Property<string>("ItemCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("NDDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("NoDBooked")
                        .HasColumnType("int");

                    b.Property<decimal>("OADepreciation")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GTERP.Models.AssetCategory", b =>
                {
                    b.Property<int>("AssetCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GTERP.Models.CostCalculated", b =>
                {
                    ...
                    b.Property<float>("CurrPrice")
                        .HasColumnType("real");

                    b.Property<float>("CurrQty")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("PrevQty")
                        .HasColumnType("real");

                    b.Property<int?>("ProductId")
                        .HasColumnType("int");

                    b.Property<float>("TotalCurrPrice")
                        .HasColumnType("real");

                    b.Property<float>("TotalPrevPrice")
                        .HasColumnType("real");
                    ...
                    b.Property<int?>("vGoodsReceiveMainGRRMainId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("vGoodsReceiveMainGRRMainId");
            ...
            modelBuilder.Entity("GTERP.Models.FinanceBook", b =>
                {
                    b.Property<int>("FinanceBookId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("FoDepreciation")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("FinanceBookId");

                    b.HasIndex("AssetCategoryId");

                    b.HasIndex("DepreciationMethodId");

                    b.ToTable("FinanceBook");
                });
            ...
            modelBuilder.Entity("GTERP.Models.GoodsReceiveSub", b =>
                {
                    ...
                    b.Property<int?>("RemainingReqQty")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GTERP.Models.Inventory", b =>
                {
                    ...
                    b.Property<float>("EnStock")
                        .HasColumnType("real");

                    b.Property<float>("GoodsRcvRtnQty")
                        .HasColumnType("real");

                    b.Property<float>("GoodsReceiveQty")
                        .HasColumnType("real");

                    b.Property<float>("IssueQty")
                        .HasColumnType("real");

                    b.Property<float>("IssueRtnQty")
                        .HasColumnType("real");

                    b.Property<float>("OpStock")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("PurExcQty")
                        .HasColumnType("real");

                    b.Property<float>("PurQty")
                        .HasColumnType("real");

                    b.Property<float>("PurRetQty")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("SalesExcQty")
                        .HasColumnType("real");

                    b.Property<float>("SalesQty")
                        .HasColumnType("real");

                    b.Property<float>("SalesRetQty")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("GTERP.Models.Items", b =>
                {
                    ...
                    b.Property<bool>("AllowAlternativeItem")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowancePercentage")
                        .HasColumnType("bit");

                    b.Property<bool>("AutoCreateAssetsonPurchase")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IncludeIteminManufacturing")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("StandardSellingRate")
                        .HasColumnType("bit");

                    b.Property<bool>("UploadImage")
                        .HasColumnType("bit");

                    b.Property<bool>("ValuationRate")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GTERP.Models.Product", b =>
                {
                    ...
                    b.Property<float>("RetailerPrice")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("GTERP.Models.AccountDetails", b =>
                {
                    b.HasOne("GTERP.Models.AssetCategory", null)
            ...
            modelBuilder.Entity("GTERP.Models.Asset", b =>
                {
                    b.HasOne("GTERP.Models.AdditionalOptions", "AdditionalOptions")
                        .WithMany()
                        .HasForeignKey("AdditionalOptionsId");

                    b.HasOne("GTERP.Models.AssetCategory", "AssetCategory")
                        .WithMany()
                        .HasForeignKey("AssetCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("GTERP.Models.Items", "Items")
                        .WithMany()
            ...
            modelBuilder.Entity("GTERP.Models.CostCalculated", b =>
                {
                    ...
                    b.HasOne("GTERP.Models.GoodsReceiveMain", "vGoodsReceiveMain")
                        .WithMany()
                        .HasForeignKey("vGoodsReceiveMainGRRMainId");
                });
            ...
            modelBuilder.Entity("GTERP.Models.Medical_Master", b =>
                {
                    ...
                    b.HasOne("GTERP.Models.Cat_MedicalDiagnosis", "Cat_MedicalDiagnosis")
                        .WithMany()
            ...
            modelBuilder.Entity("GTERP.Models.Production", b =>
                {
                    b.HasOne("GTERP.Models.ItemDesc", "ItemDesc")
                        .WithMany()
                        .HasForeignKey("ItemDescId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GTERP.Models.Unit", "Unit")
                        .WithMany()
                        .HasForeignKey("UnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
