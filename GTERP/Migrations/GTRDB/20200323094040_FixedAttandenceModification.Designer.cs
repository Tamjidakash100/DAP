...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20200323094040_FixedAttandenceModification")]
    partial class FixedAttandenceModification
    {
            ...
            modelBuilder.Entity("GTERP.Models.HR_AttFixed", b =>
                {
                    ...
                    b.Property<int?>("Cat_AttStatusStatusId")
                        .HasColumnType("int");

                    b.Property<int?>("Cat_ShiftShiftId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("HR_Emp_InfoEmpId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Cat_AttStatusStatusId");

                    b.HasIndex("Cat_ShiftShiftId");

                    b.HasIndex("HR_Emp_InfoEmpId");
            ...
            modelBuilder.Entity("GTERP.Models.HR_AttFixed", b =>
                {
                    b.HasOne("GTERP.Models.Cat_AttStatus", "Cat_AttStatus")
                        .WithMany()
                        .HasForeignKey("Cat_AttStatusStatusId");

                    b.HasOne("GTERP.Models.Cat_Shift", "Cat_Shift")
                        .WithMany()
                        .HasForeignKey("Cat_ShiftShiftId");

                    b.HasOne("GTERP.Models.HR_Emp_Info", "HR_Emp_Info")
                        .WithMany()
                        .HasForeignKey("HR_Emp_InfoEmpId");
                });
