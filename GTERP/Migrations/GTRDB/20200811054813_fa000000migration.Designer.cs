...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20200811054813_fa000000migration")]
    partial class fa000000migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GTERP.Models.FA_FixedAsset", b =>
                {
                    b.Property<int>("FA_FixedAssetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("AccumulateDepreciationAccountId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DepreciationMethodDMId")
                        .HasColumnType("int");

                    b.Property<decimal>("DeprecitionRate")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasKey("FA_FixedAssetId");

                    b.HasIndex("DepreciationMethodDMId");

                    b.HasIndex("ProductId");

                    b.ToTable("FA_FixedAssets");
                });

            modelBuilder.Entity("GTERP.Models.FA_FixedAssetAdd", b =>
                {
                    b.Property<int>("FA_FixedAssetAddId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("FA_FixedAssetAddId");

                    b.HasIndex("FA_FixedAssetId");

                    b.ToTable("FA_FixedAssetAdd");
                });

            modelBuilder.Entity("GTERP.Models.FA_FixedAssetCalculation", b =>
                {
                    b.Property<int>("FA_FixedAssetCalculationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("FA_FixedAssetCalculationId");

                    b.HasIndex("FA_FixedAssetAddId");

                    b.ToTable("FA_FixedAssetCalculation");
                });

            modelBuilder.Entity("GTERP.Models.FA_FixedAssetSell", b =>
                {
                    b.Property<int>("FA_FixedAssetSellId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("FA_FixedAssetSellId");

                    b.HasIndex("FA_FixedAssetId");

                    b.ToTable("FA_FixedAssetSell");
                });
            ...
            modelBuilder.Entity("GTERP.Models.FA_FixedAsset", b =>
                {
                    b.HasOne("GTERP.Models.DepreciationMethod", "DepreciationMethod")
                        .WithMany()
                        .HasForeignKey("DepreciationMethodDMId");
            ...
            modelBuilder.Entity("GTERP.Models.FA_FixedAssetAdd", b =>
                {
                    b.HasOne("GTERP.Models.FA_FixedAsset", "FixedAsset")
                        .WithMany()
                        .HasForeignKey("FA_FixedAssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GTERP.Models.FA_FixedAssetCalculation", b =>
                {
                    b.HasOne("GTERP.Models.FA_FixedAssetAdd", "FixedAssetAdd")
                        .WithMany()
                        .HasForeignKey("FA_FixedAssetAddId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GTERP.Models.FA_FixedAssetSell", b =>
                {
                    b.HasOne("GTERP.Models.FA_FixedAsset", "FA_FixedAsset")
                        .WithMany()
                        .HasForeignKey("FA_FixedAssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
