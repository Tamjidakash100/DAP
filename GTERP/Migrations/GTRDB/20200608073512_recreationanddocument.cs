...
{
    public partial class recreationanddocument : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "HR_Emp_Document",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RefCode = table.Column<string>(maxLength: 20, nullable: true),
                    Title = table.Column<string>(maxLength: 100, nullable: true),
                    Remarks = table.Column<string>(maxLength: 200, nullable: true),
                    DocLocation = table.Column<string>(maxLength: 250, nullable: true),
                    ComId = table.Column<string>(maxLength: 80, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HR_Emp_Document", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "HR_Emp_Recreation",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmpId = table.Column<int>(nullable: false),
                    DtPayment = table.Column<DateTime>(nullable: true),
                    IsRereation = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HR_Emp_Recreation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HR_Emp_Recreation_HR_Emp_Info_EmpId",
                        column: x => x.EmpId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HR_Emp_Recreation_EmpId",
