...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20201004180503_FixedAssetMasterTable")]
    partial class FixedAssetMasterTable
    {
            ...
            modelBuilder.Entity("GTERP.Models.FA_Master", b =>
                {
                    ...
                    b.Property<int>("AccId_AccumulateDepreciation")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccId_AccumulateDepreciation");
            ...
            modelBuilder.Entity("GTERP.Models.FA_Master", b =>
                {
                    b.HasOne("GTERP.Models.Acc_ChartOfAccount", "AccumulatedDepreciationHead")
                        .WithMany()
                        .HasForeignKey("AccId_AccumulateDepreciation")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
