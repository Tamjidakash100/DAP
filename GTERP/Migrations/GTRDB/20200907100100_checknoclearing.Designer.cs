...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20200907100100_checknoclearing")]
    partial class checknoclearing
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GTERP.Models.Acc_VoucherSubCheckno_Clearing", b =>
                {
                    b.Property<int>("VoucherSubCheckNoClearingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("dtChkClear")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("VoucherSubCheckNoClearingId");

                    b.HasIndex("VoucherSubCheckId");

                    b.ToTable("Acc_VoucherSubCheckno_Clearings");
                });
            ...
            modelBuilder.Entity("GTERP.Models.Booking", b =>
                {
                    ...
                    b.HasIndex("ComId", "FiscalYearId", "FiscalMonthId", "CustomerId")
                        .IsUnique()
            ...
            modelBuilder.Entity("GTERP.Models.DownTime", b =>
                {
                    ...
                    b.Property<float?>("MoneyLoss")
                        .HasColumnType("real");

                    b.Property<int>("PrdUnitId")
                        .HasColumnType("int");

                    b.Property<float?>("ProductionLoss")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("GTERP.Models.FA_Master", b =>
                {
                    ...
                    b.Property<int?>("Acc_ChartOfAccountAccId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Acc_ChartOfAccountAccId");
            ...
            modelBuilder.Entity("GTERP.Models.LabourStrike", b =>
                {
                    b.Property<int>("LabourStrikeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("LabourStrikeId");

                    b.HasIndex("PrdUnitId");

                    b.HasIndex("ReasonId");

                    b.ToTable("LabourStrike");
                });
            ...
            modelBuilder.Entity("GTERP.Models.Acc_VoucherSubCheckno_Clearing", b =>
                {
                    b.HasOne("GTERP.Models.Acc_VoucherSubCheckno", "Acc_VoucherSubChecknos")
                        .WithMany("Acc_VoucherSubCheckno_Clearings")
                        .HasForeignKey("VoucherSubCheckId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GTERP.Models.FA_Master", b =>
                {
                    b.HasOne("GTERP.Models.Acc_ChartOfAccount", "Acc_ChartOfAccount")
                        .WithMany()
                        .HasForeignKey("Acc_ChartOfAccountAccId");
