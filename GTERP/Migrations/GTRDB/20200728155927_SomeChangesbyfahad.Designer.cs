...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20200728155927_SomeChangesbyfahad")]
    partial class SomeChangesbyfahad
    {
            ...
            modelBuilder.Entity("GTERP.Models.GoodsReceiveMain", b =>
                {
                    ...
                    b.HasIndex("ComId", "GRRNo")
                        .IsUnique()
                        .HasFilter("[ComId] IS NOT NULL AND [GRRNo] IS NOT NULL");
            ...
            modelBuilder.Entity("GTERP.Models.IssueMain", b =>
                {
                    ...
                    b.HasIndex("ComId", "IssueNo")
                        .IsUnique()
                        .HasFilter("[ComId] IS NOT NULL AND [IssueNo] IS NOT NULL");
            ...
            modelBuilder.Entity("GTERP.Models.PurchaseOrderMain", b =>
                {
                    ...
                    b.HasIndex("ComId", "PONo")
                        .IsUnique()
                        .HasFilter("[ComId] IS NOT NULL AND [PONo] IS NOT NULL");
            ...
            modelBuilder.Entity("GTERP.Models.PurchaseRequisitionMain", b =>
                {
                    ...
                    b.HasIndex("ComId", "PRNo")
                        .IsUnique()
                        .HasFilter("[ComId] IS NOT NULL AND [PRNo] IS NOT NULL");
            ...
            modelBuilder.Entity("GTERP.Models.StoreRequisitionMain", b =>
                {
                    ...
                    b.HasIndex("ComId", "SRNo")
                        .IsUnique()
                        .HasFilter("[ComId] IS NOT NULL AND [SRNo] IS NOT NULL");
