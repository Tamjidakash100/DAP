...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20210216184815_ChartofAccountchangename")]
    partial class ChartofAccountchangename
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GTERP.Models.Acc_ChartOfAccount_PF", b =>
                {
                    b.Property<int>("AccId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Acc_ChartOfAccounts_PF");
                });
            ...
            modelBuilder.Entity("GTERP.Models.Acc_VoucherMain_PF", b =>
                {
                    b.Property<int>("VoucherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GTERP.Models.Acc_VoucherSub_PF", b =>
                {
                    b.Property<int>("VoucherSubId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Acc_VoucherSub_PF");
                });

            modelBuilder.Entity("GTERP.Models.Acc_VoucherSub_PFCheckno", b =>
                {
                    b.Property<int>("VoucherSubCheckId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Acc_VoucherSub_PFCheckno");
                });

            modelBuilder.Entity("GTERP.Models.Acc_VoucherSub_PFSection", b =>
                {
                    b.Property<int>("VoucherSubSectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Acc_VoucherSub_PFSection");
                });
            ...
            modelBuilder.Entity("GTERP.Models.Acc_ChartOfAccount_PF", b =>
                {
                    b.HasOne("GTERP.Models.Acc_ChartOfAccount_PF", "ParentChartOfAccount")
                        .WithMany()
                        .HasForeignKey("ParentID");
                });
            ...
            modelBuilder.Entity("GTERP.Models.Acc_VoucherSub_PF", b =>
                {
                    b.HasOne("GTERP.Models.Acc_ChartOfAccount_PF", "Acc_ChartOfAccount_PF")
                        .WithMany()
                        .HasForeignKey("AccId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("GTERP.Models.Acc_VoucherMain_PF", "Acc_VoucherMain_PF")
                        .WithMany("VoucherSubs")
                        .HasForeignKey("VoucherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GTERP.Models.Acc_VoucherSub_PFCheckno", b =>
                {
                    b.HasOne("GTERP.Models.Acc_ChartOfAccount_PF", "vAcc_ChartOfAccount_PF")
                        .WithMany()
                        .HasForeignKey("AccId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GTERP.Models.Acc_VoucherSub_PF", "Acc_VoucherSub_PF")
                        .WithMany("VoucherSubChecnoes")
                        .HasForeignKey("VoucherSubId");
                });
            ...
            modelBuilder.Entity("GTERP.Models.Cat_PFIntegrationSummary", b =>
                {
                    b.HasOne("GTERP.Models.Acc_ChartOfAccount_PF", "Acc_ChartOfAccounts")
                        .WithMany()
                        .HasForeignKey("AccId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
