...
namespace GTERP.Migrations.GTRDB
{
    ...
    [Migration("20200308120911_GradeName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GTERP.Models.Department", b =>
                {
                    ...
                    b.Property<string>("DptSrtName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<byte?>("IsStrDpt")
            ...
            modelBuilder.Entity("GTERP.Models.Designation", b =>
                {
                    ...
                    b.Property<byte>("MngSalary")
                        .HasColumnType("tinyint");

                    b.Property<string>("OffGrade")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pcname")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("ShiftAllow")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GTERP.Models.Grade", b =>
                {
            ...
            modelBuilder.Entity("GTERP.Models.Section", b =>
                {
                    ...
                    b.Property<byte>("ComId")
                        .HasColumnType("tinyint");

                    b.Property<short?>("CostSect")
                        .HasColumnType("smallint");

                    b.Property<decimal?>("CostSectTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<short?>("CostSubSect")
                        .HasColumnType("smallint");
                    ...
                    b.Property<string>("EmpIdSrtName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GTERP.Models.SubSection", b =>
                {
                    b.Property<int>("SubSectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GTERP.Models.Employee", b =>
                {
                    ...
                    b.HasOne("GTERP.Models.SubSection", "SubSection")
                        .WithMany()
            ...
            modelBuilder.Entity("GTERP.Models.Section", b =>
                {
                    b.HasOne("GTERP.Models.Department", "Dept")
                        .WithMany("Section")
            ...
            modelBuilder.Entity("GTERP.Models.SubSection", b =>
                {
                    ...
                    b.HasOne("GTERP.Models.Section", "Sect")
                        .WithMany("SubSection")
