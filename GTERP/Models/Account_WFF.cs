...
{
    public class WFF_ChartOfAccount
    {
        ...
        public virtual WFF_ChartOfAccount ParentChartOfAccount { get; set; }

        ///public virtual ICollection<WFF_ChartOfAccount> ChartOfAccountChildren { get; set; }
        ...
        //[Display(Name = "Group")]
        //public virtual WFF_ChartOfAccount vAccountGroup { get; set; } = null;
        ...
        //public virtual ICollection<WFF_VoucherSub> VoucherSubs { get; set; }


    }

    public partial class WFF_VoucherMain
    {
        //[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        //public WFF_VoucherMain()
        //{
        //    this.VoucherSubs = new HashSet<WFF_VoucherSub>();
        //}
        [Key]
        ...
        //public virtual WFF_ChartOfAccount WFF_ChartOfAccount { get; set; }
        ...
        //public virtual WFF_ChartOfAccount vChartofAccountsMain { get; set; }
        //public virtual Acc_VoucherType vVoucherType { get; set; }

        //public virtual WFF_VoucherSub vVouchersubMain { get; set; }
        [Display(Name = "Fiscal Year")]
    ...
    public partial class WFF_VoucherSub
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public WFF_VoucherSub()
        {
            this.VoucherSubChecnoes = new HashSet<WFF_VoucherSubCheckno>();
            this.VoucherSubSections = new HashSet<WFF_VoucherSubSection>();
        }
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Key]
        ...
        //public virtual WFF_VoucherMain WFF_VoucherMain { get; set; }
        //[InverseProperty("WFF_VoucherSub")]
        [ForeignKey("VoucherId")]

        public virtual WFF_VoucherMain WFF_VoucherMain { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]

        public virtual ICollection<WFF_VoucherSubCheckno> VoucherSubChecnoes { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<WFF_VoucherSubSection> VoucherSubSections { get; set; }
    ...
    public class WFF_VoucherSubSection
    {
        [Key]
        ...
        public virtual WFF_VoucherSub WFF_VoucherSub { get; set; }
    }

    public class WFF_VoucherSubCheckno
    {
        [Key]
        ...
        [ForeignKey("AccId")]
        public virtual WFF_ChartOfAccount vWFF_ChartOfAccount { get; set; }
        ...
        //public virtual ICollection<WFF_VoucherSubCheckno_Clearing> WFF_VoucherSubCheckno_Clearings { get; set; }
    }

    public partial class Cat_WFFIntegrationSummary
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int Cat_WFFIntegrationSummaryId { get; set; }
        ...
        public int AccId { get; set; }
        [ForeignKey("AccId")]
        public virtual WFF_ChartOfAccount WFF_ChartOfAccounts { get; set; }
