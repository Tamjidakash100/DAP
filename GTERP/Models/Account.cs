...
namespace GTERP.Models
{
    ...
    public class Acc_ChartOfAccount
    {
    ...
    public class Acc_FiscalMonth
    {
        ...
        public virtual ICollection<FactoryInfomation> FactoryInfos { get; set; }
        public virtual ICollection<SalesOpening> SalesOpeningBalances { get; set; }
        public virtual ICollection<ReceivedFromBufferBankAmountsModels> ReceivedFromBufferBankAmounts { get; set; }
        public virtual ICollection<BufferSaleReportInput> BufferSaleReportInputs { get; set; }
        public ICollection<BufferFactoryInfomation> BufferFactoryInfomations { get; set; }
        public ICollection<BufferAllotment_MOA> BufferAllotment_MOA { get; set; }
    ...
    public partial class NoteDescription
    {
        [Key]
    ...
    public partial class Acc_VoucherMain
    {
    ...
    public class Acc_VoucherSubCheckno
    {
        [Key]
    ...
    public partial class Acc_VoucherNoPrefix
    {
    ...
    public class Acc_GovtSchedule_Equity
    {
        [Key]
        public int GovtScheduleId { get; set; }
    ...
    public class Acc_Contingent_Liability
    {
        [Key]
        public int ContingentLiabilityId { get; set; }
        public string Description { get; set; }
        public DateTime FromDate { get; set; }
        public DateTime ToDate { get; set; }
    ...
    public class Acc_GovtSchedule_ForeignLoan
    {
        [Key]
        public int GovtScheduleId { get; set; }
    ...
    public class Acc_GovtSchedule_JapanLoan
    {
        [Key]
        public int GovtScheduleId { get; set; }
    ...
    public partial class CartOrderMain
    {
        [Key]
    ...
    public class CostAllocation_Main
    {
        [Key]
    ...
    public class Acc_BudgetRelease
    {
        [Key]
