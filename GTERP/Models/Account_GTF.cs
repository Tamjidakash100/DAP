...
{
    public class GTF_ChartOfAccount
    {
        ...
        public virtual GTF_ChartOfAccount ParentChartOfAccount { get; set; }

        ///public virtual ICollection<GTF_ChartOfAccount> ChartOfAccountChildren { get; set; }
        ...
        //[Display(Name = "Group")]
        //public virtual GTF_ChartOfAccount vAccountGroup { get; set; } = null;
        ...
        //public virtual ICollection<GTF_VoucherSub> VoucherSubs { get; set; }


    }

    public partial class GTF_VoucherMain
    {
        //[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        //public GTF_VoucherMain()
        //{
        //    this.VoucherSubs = new HashSet<GTF_VoucherSub>();
        //}
        [Key]
        ...
        //public virtual GTF_ChartOfAccount GTF_ChartOfAccount { get; set; }
        ...
        //public virtual GTF_ChartOfAccount vChartofAccountsMain { get; set; }
        //public virtual Acc_VoucherType vVoucherType { get; set; }

        //public virtual GTF_VoucherSub vVouchersubMain { get; set; }
        [Display(Name = "Fiscal Year")]
    ...
    public partial class GTF_VoucherSub
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public GTF_VoucherSub()
        {
            this.VoucherSubChecnoes = new HashSet<GTF_VoucherSubCheckno>();
            this.VoucherSubSections = new HashSet<GTF_VoucherSubSection>();
        }
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Key]
        ...
        //public virtual GTF_VoucherMain GTF_VoucherMain { get; set; }
        //[InverseProperty("GTF_VoucherSub")]
        [ForeignKey("VoucherId")]

        public virtual GTF_VoucherMain GTF_VoucherMain { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]

        public virtual ICollection<GTF_VoucherSubCheckno> VoucherSubChecnoes { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<GTF_VoucherSubSection> VoucherSubSections { get; set; }
    ...
    public class GTF_VoucherSubSection
    {
        [Key]
        ...
        public virtual GTF_VoucherSub GTF_VoucherSub { get; set; }
    }

    public class GTF_VoucherSubCheckno
    {
        [Key]
        ...
        [ForeignKey("AccId")]
        public virtual GTF_ChartOfAccount vGTF_ChartOfAccount { get; set; }
        ...
        //public virtual ICollection<GTF_VoucherSubCheckno_Clearing> GTF_VoucherSubCheckno_Clearings { get; set; }
    }

    public partial class Cat_GTFIntegrationSummary
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int Cat_GTFIntegrationSummaryId { get; set; }
        ...
        public int AccId { get; set; }
        [ForeignKey("AccId")]
        public virtual GTF_ChartOfAccount GTF_ChartOfAccounts { get; set; }
