...
namespace GTERP.Models.Common
{
    public class clsConnectionNew
    {
        ...
        private void GTRMakeConnectionString(string strDatabaseName, Boolean IsWeb)
        {
            ...
            strConnection = ConfigurationManager.ConnectionStrings["ApplicationServices"].ConnectionString;
        }
        ...
        private void GTRConnectionOpen()
        {
            ...
            //var connString = ConfigurationManager.ConnectionStrings["MasterDetailsEntities"].ConnectionString;
